            ...
            <table class="table table-bordered">
                ...
                @foreach($users as $key => $user)
                    <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td>
                            <a href="{{ route('users.show',$user->id)}}" type="button" class="btn btn-outline-warning">
                            ...
                            <a href="{{route('users.edit',$user->id)}}" type="button" class="btn btn-outline-success">
                            ...
                            <a onclick="confirm('Bạn muốn xóa người dùng này?')" href="{{route('users.delete',$user->id)}}" type="button" class="btn btn-outline-danger">
